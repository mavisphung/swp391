...
namespace Backend.Service.Annotations
{
    public class NumericLessThanAttribute : ValidationAttribute
    {
        ...
        {
            if (otherProperty == null) { throw new ArgumentNullException("There must be another property to be compared"); }
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            // Make this annotation skip FromPrice if there is no FromPrice in query parameters
            if (value == null)
            {
                return null;
            }
